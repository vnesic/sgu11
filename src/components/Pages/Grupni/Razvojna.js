...
function Razvojna(){
    ...
    return(
        ...
        <div>
            ...
            <p>U želji da se posebna pažnja usmeri na pravilan rast i razvoj svih funkcija deteta, oformljena je grana sportske gimnastike – razvojna gimnastika. Kako ovaj program obuhvata veliki broj najrazličitijih kretnji, deca ga doživljavaju kao vrlo zabavnu aktivnost, koja u isto vreme ima i preventivno delovanje na telesni status. Pred njima su brojni motorički zadaci za koje je potrebna koordinacija, spretnost, izdržljivost, snaga, ravnoteža, a njihovim rešavanjem deca pozitivno utiču na svoje kognitivne sposobnosti (inteligencija) i crte ličnosti (hrabrost, samopouzdanje i dr.). Drugim rečima, deca se igraju i istovremeno pozitivno utiču na svoje zdravlje i razvoj, uz to stičući radne navike i kolektivni duh. Glavni cilj ovog programa je da kroz igru deca nauče nove veštine, razviju pravilno držanje i spreči pojavu mogućih telesnih deformiteta kojima su deca u toku razvoja veoma podložna.</p>
            <blockquote className="quotation">
                <p>J.Ažman, ispitivajući uticaj sporta na ličnost čoveka, došao je do zaključka da se na prvom mestu nalaze gimnastičari kada je ocenjivana disciplinovanost i smisao za drugarstvo.</p>
            </blockquote>
        </div>
       </Row>
